    ...
    <>
...

      {
        ...
        <div className='absolute z-10 w-screen h-screen backdrop-blur-md'>
          <div className={classNames(inter.className, 'absolute left-0 h-screen overflow-y-auto bg-green-950 z-10 p-4 shadow-md', sidebarStatus ? 'w-screen md:w-2/6 lg:w-1/6 min-h-screen  ' : 'hidden')}>
            <div className='flex flex-row justify-between'>
              ...
              >
                Close
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-2 lucide lucide-panel-right-open"><rect width="18" height="18" x="3" y="3" rx="2" ry="2" /><line x1="15" x2="15" y1="3" y2="21" /><path d="m10 15-3-3 3-3" /></svg>
              </button>
            </div>
          </div>
        </div>
